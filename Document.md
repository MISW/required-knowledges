...
そんな「プログラミング言語の知識」では無いけれども、「プログラミングの知識」として必要ないくつかの事柄について、どんなときに使える知識かで分けて紹介します。  
...
正直なところ、以下の内容についてはプログラミングを始めたばかりで読んでもよくわからない部分が多いと思います。私も最初はよくわかりませんでした。  
しかし、やっぱり必要になるときはちゃんとあって、そして一度こういった入門サイトを読んで一通り扱えるようになったら、プログラミング中世からプログラミング現代までジェネレーションがアドバンスするくらいの衝撃がありました。  
今後の方針の参考となるかもしれませんので、まずは一通り言葉の意味をなんとなくでも良いので知ってください。  
...
これはとても重要なことで、言語やツールをうまく選ばないと、作るものによっては非常に難しくなります。  
また、プログラミング言語ごとに何ができるかを知っておけば、何を作るかということの参考にできます。  
[1]によくまとまっています。専門用語も多いので、わからない単語があったらGoogle検索で調べましょう。どれも重要な単語です。  
